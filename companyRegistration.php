...
<div class="container"><br>
    <h4 style="color:orange;text-decoration:underline" class="font-weight-bold">Company Registraction Form :</h4>
    <div class="row">
        <div class="col-md-6" style="border-right:1px solid rgba(0, 0, 0, 0.3)"><br>
            ...
            <ul>
                ...
                <li>Search, Shortlist & Select Applicants</li>
            </ul>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-5">
            <form action="insertCompanies.php" method="post" class="md-form was-validated">
                <h5 class="text-danger text-center">Register Here: <small style="color:blue;background-color:yellow;padding:4px;border-radius:5px">Find The Best Talented Students Here</small></h5>
           ...
           <!--     <input type="text" class="form-control" name="username" pattern=".{6,}" title="Atkeast 6 or more charcters" placeholder="User Name" required>    6 or more chars   -->
                ...
                <button class="btn btn-warning px-3"><a href="c_loginForm.php">Login</a></button>
