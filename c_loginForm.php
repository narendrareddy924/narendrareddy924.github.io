...
<form class="md-form container animated flipInY mt-5" action="c_process.php" method="post">
    <div class="card w-50 m-auto">
        <div class="card-header">
            <h3 class="text-primary text-center">Company Login Form</h3>
        </div>
        <div class="card-body">
            ...
            <input class="btn btn-success rounded" type="submit" value="Login" name="login">
            <span class="text-danger">Not Yet Registered Sign Up Here</span>
            <button class="btn btn-warning"><a href="companyRegistration.php">Sign Up</a></button><hr>
