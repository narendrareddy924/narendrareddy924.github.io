...
technologies = ['HTML','CSS','JavaScript','Bootstrap','JQuery'];
console.log(technologies);
technologies.unshift('Angular JS','hiii');
console.log(technologies);
...
// splice(index)
console.log(technologies);
technologies.splice(1); //technologies.splice(-1); - it deletes last one
console.log(technologies);

// splice(index,no of elements)
technologies = ['HTML','CSS','JavaScript','Bootstrap','JQuery'];
console.log(technologies);
technologies.splice(1,3);
console.log(technologies);

// splice(index,1,replace)
technologies = ['HTML','CSS','JavaScript','Bootstrap','JQuery'];
console.log(technologies);
technologies.splice(1,1,'Node JS');
console.log(technologies);
...
// indexOf()
arr1 = [10,20,30,40,50];
console.log('Index of 30 is : ' + arr1.indexOf(300)); //it dont takes as undefined but takes as -1
